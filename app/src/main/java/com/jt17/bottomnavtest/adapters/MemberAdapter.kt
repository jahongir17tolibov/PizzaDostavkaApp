...
class MemberAdapter(val list: List<com.jt17.bottomnavtest.models.Result.Member>, val itemCallback: itemCallback) :
    ...
    inner class ItemHolder(val bind: PizzaMenuItemBinding) : RecyclerView.ViewHolder(bind.root) {
        fun binder(result: com.jt17.bottomnavtest.models.Result.Member) {
